...
public class BuyingOrderFragment extends AbsSpiceFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        OrderListAdapter adapter = new OrderListAdapter(orderList, "Buying");
        adapter.setOnItemClickListener(new AbsListAdapter.OnItemClickListener<Order>() {
            ...
            public void onItemClick(Order item) {
                ...
                i.putExtra("ORDER_ID", Integer.parseInt(item.order_id));
                i.putExtra("ORDER_TYPE", "Buying");
                startActivity(i);
            }
        });
        ...
        getSpiceManager().execute(
                new GetMyOrderListRequest(getActivity(), "Buying"),
